(
    ...
    function() {
        ...
        if (!localStorage.getItem('books')) {
            ...
            manager.addBooks(...JSON.parse(localStorage.getItem('books')));
        }
        ...
        function populateList(books) {
            ...
            books.forEach(book => {
                ...
                <tr>
                    ...
                    <td>${book.rating}</td>
                    <td>
                        <button id="delete-button-${book.isbn}">Delete</button> 
                        <a href="edit.html"><button id="edit-button-${book.isbn}">Edit</button> </a>
                    </td>
                </tr>
            ...
            for (let book of manager.db) {
                document.getElementById("delete-button-"+ book.isbn).onclick = deleteBook;
                document.getElementById("edit-button-"+ book.isbn).onclick = editBook;
            }
        ...
        function deleteBook() { 
            console.log("delete")
            manager.removeBook(this.id.slice(14));
            populateList(JSON.parse(localStorage.getItem('books')));
        }
        function editBook() {
            localStorage.setItem('bookToEdit', this.id.slice(12));
        }
