      ...
      <div className="BookListInfoScreen">
        ...
        <div className="row">
          <div className="col col-3">
            <BookListComponent books={this.state.books}activeBook={this.state.activeBook}  onBookClick={this.handleBookClick} />
          </div>
          <div className="col col-9">
            <BookDetailsComponent book={this.state.activeBook} />
          </div>
        </div>
      </div>
    );
